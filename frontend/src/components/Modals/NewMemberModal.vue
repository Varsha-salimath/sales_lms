	...
	try {
		const user = await call('frappe.client.insert', {
			doc: {
				...
				mobile_no: member.mobile_no.trim() || undefined,
				school_name: member.school_name.trim() || undefined,
				college: member.school_name.trim() || undefined,
			},
		})
